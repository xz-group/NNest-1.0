...
int main(){
	...
	ofstream dram_data_file("./MH_PR_result/MH_PR_dram.txt");
	ofstream energy_data_file("./MH_PR_result/MH_PR_energy.txt");

	ofstream out_data_file("./MH_PR_result/MH_PR_design_space.txt");

	ofstream GLB_data_file("./MH_PR_result/MH_PR_design_space_GLB.txt");
	ofstream LB_data_file("./MH_PR_result/MH_PR_design_space_LB.txt");
	ofstream NoC_data_file("./MH_PR_result/MH_PR_design_space_NoC.txt");
	ofstream PE_data_file("./MH_PR_result/MH_PR_design_space_PE.txt");

	ofstream PE_sum_data_file("./MH_PR_result/MH_PR_design_space_PE_sum.txt");

	ofstream PE_area_division_data_file("./MH_PR_result/MH_PR_design_space_PE_area_division.txt");
	ofstream PE_power_division_data_file("./MH_PR_result/MH_PR_design_space_PE_area_division.txt");
	ofstream PE_latency_division_data_file("./MH_PR_result/MH_PR_design_space_PE_area_division.txt");

	ofstream CLK_data_file("./MH_PR_result/MH_PR_design_space_CLK.txt");

	ofstream area_division_data_file("./MH_PR_result/MH_PR_area_division.txt");
	ofstream latency_division_data_file("./MH_PR_result/MH_PR_latency_division.txt");
	ofstream dynamic_power_division_data_file("./MH_PR_result/MH_PR_dynamic_power_division.txt");
	ofstream leakage_power_division_data_file("./MH_PR_result/MH_PR_leakage_power_division.txt");
	...
	for(ttm = 1; ttm <= ttm_max; ttm++){
		for(tte = 1; tte <= tte_max; tte+=1){
			for(ttc = 2; ttc <= ttc_max; ttc+=2){
				...
				psum_num_access_per_cycle = ttm*tte;

				// C * (R-U+U*TTe) * (U*Tf)*(S-U+U*F/U*Tf)
				int num_input_GLB_SRAM = R-1+Te;
				int input_block_size_inByte = ttc * (input_bitwidth/8); 
				int input_num_blocks = int( F * ceil(C/ttc) );
				float input_GB_read_activity_factor =  float(R-1+tte) / float(R-1+Te);
				float input_GB_write_activity_factor = float(tte) / float(R-1+Te);
				...
				int psum_block_size_inByte = ceil(output_bitwidth/8);
				int psum_num_blocks = int( ttm*tte * F);
				...
				/* --------------------- 2.2 weight NoC --------------------------*/
				// weight GLB out = (Tm * Tc*R*S) * 1  --> PE = (Tm * Tc*R*S) * Tn*Te*T
				...
				area_division_data_file<<GLB_area<<", "<<LB_area<<", "<<NoC_area<<", "<<PE_area<<", ";
				area_division_data_file<<GLB_area_div<<", "<<LB_area_div<<", "<<NoC_area_div<<", "<<PE_area_div<<endl;
				...
				latency_division_data_file<<GLB_latency_div<<", "<<LB_latency_div<<", "<<NoC_latency_div<<", "<<PE_latency_div<<endl;
				...
				dynamic_power_division_data_file<<GLB_dynamic_power<<", "<<LB_dynamic_power<<", "<<NoC_dynamic_power<<", "<<PE_dynamic_power<<", ";
				dynamic_power_division_data_file<<GLB_dynamic_power_div<<", "<<LB_dynamic_power_div<<", "<<NoC_dynamic_power_div<<", "<<PE_dynamic_power_div<<endl;
				...
				energy_data_file<<total_energy<<", "<<dram_energy<<", "<<GLB_energy<<", "<<LB_energy<<", "<<NoC_energy<<", "<<PE_energy<<", ";
				...
				energy_data_file<<dram_energy_div<<", "<<GLB_energy_div<<", "<<LB_energy_div<<", "<<NoC_energy_div<<", "<<PE_energy_div<<endl;
				...
				out_data_file<<total_area<<", "<<total_dynamic_power<<endl;
